...
it('toString and fromString should be opposites', function(){
    var startTree =
      [{title: "howdy",
          children: [
            {title: "billy"},
            {title: "suzie", children: [
              {title: "puppy", children: [
                {title: "dog house"}
              ]},
              {title: "cherry thing"}
            ]}
...
it('testSelectNext', function() {
    ...
    // TODO make statements like this more clear about why the first call is children[0]... it's because
    // this is wrapped in some root node.
    var tree = Tree.makeTree(treeNext2).children[0].children[1].children[0].children[0];
